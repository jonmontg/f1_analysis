...
xgboost.predictions <- preds
xgboost.actual <- actual
```
...
```{r}
print(chisq.test(table(naive.predict.same.as.mode(test.data), test.data$raceResultQualitative)))
print(comparison.report(naive.predict.same.as.mode(test.data), test.data$raceResultQualitative))
```
### Statistics for Naive Same as Last
```{r}
print(chisq.test(table(naive.predict.same.as.last(test.data), test.data$raceResultQualitative)))
print(comparison.report(naive.predict.same.as.last(test.data), test.data$raceResultQualitative))
```
### Statistics for Naive Same as Starting Position
```{r}
print(chisq.test(table(naive.predict.same.as.start(test.data), test.data$raceResultQualitative)))
print(comparison.report(naive.predict.same.as.start(test.data), test.data$raceResultQualitative))
```
